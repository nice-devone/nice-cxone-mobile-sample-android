...
import com.nice.cxonechat.models.message.MessageElement;
            ...
            if (payloadElements.size() > 1) {
                ...
                for (MessageElement payloadElement : payloadElements) {
                    ...
                    for (MessageElement element : messageElements) {
                        if (element.getType().equals(ElementType.File)) {
                ...
                if (!payloadElements.get(0).getElements().isEmpty()) {
                    ...
                    if (payloadElements.get(0).getType() == ElementType.SatisfactionSurvey) {
                        if (payloadElements.get(0).getElements().size() > 1) {
                            TextView textView = new TextView(bubble.getContext());
                            textView.setText(payloadElements.get(0).getElements().get(0).getText());
                            bubble.addView(textView);

                            Button button = new Button(bubble.getContext());
                            button.setText(payloadElements.get(0).getElements().get(1).getText());
                            button.setOnClickListener(view -> {
                                try {
                                    Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse(payloadElements.get(0).getElements().get(1).getUrl()));
                                    bubble.getContext().startActivity(browserIntent);
                                }
                                catch(Exception e) {
                                    e.printStackTrace();
                                }
                        ...
                        for (MessageElement element : messageElements) {
                            if (element.getType() != null) {
                                if (element.getType().equals(ElementType.Text)) {
                                    ...
                                    bubble.addView(textView);
                                } else if (element.getType().equals(ElementType.Button)) {
                                    Button button = new Button(bubble.getContext());
                                    button.setText(element.getText());
                                    bubble.addView(button);
                                } else if (element.getType().equals(ElementType.File)) {
                                ...
                                } else if (element.getType().equals(ElementType.Title)) {
                                    TextView textView = new TextView(bubble.getContext());
                                    textView.setText(element.getText());
                    ...
                    bubble.removeAllViews();
                    if (messageElement.getType().equals(ElementType.Text)) {
                        TextView textView = new TextView(bubble.getContext());
                        textView.setText(messageElement.getText());
                        bubble.addView(textView);
                    } else if (messageElement.getType().equals(ElementType.Button)) {
                        Button button = new Button(bubble.getContext());
                        ...
                        bubble.addView(button);
                    } else if (messageElement.getType().equals(ElementType.File)) {
                        ImageView imageView = new ImageView(bubble.getContext());
                        imageView.setScaleType(ImageView.ScaleType.FIT_XY);
                        Picasso.get().load(messageElement.getUrl()).into(imageView);
                        bubble.addView(imageView);
                    } else if (messageElement.getType().equals(ElementType.Title)) {
                        TextView textView = new TextView(bubble.getContext());
                        textView.setText(messageElement.getText());
                        textView.setTextSize(16);
                        textView.setTypeface(Typeface.DEFAULT_BOLD);
                        bubble.addView(textView);
                    }  else if (messageElement.getType().equals(ElementType.Custom)) {
